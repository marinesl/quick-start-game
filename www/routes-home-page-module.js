        ...
        */
        ...
        this.submitForm = function () {
            ...
            if (_this.form.value.password !== _this.form.value.securePassword) {
                ...
                _this.formData = {
                    email: _this.form.value.email,
                    first_name: _this.form.value.first_name,
                    last_name: _this.form.value.last_name,
                    password: _this.form.value.password,
                };
                // Use event emmiter
                _this.sendFormData.emit(_this.formData);
...
var HomePageComponent = /** @class */ (function () {
    // Module injection
    function HomePageComponent(AuthService, router // Navigation
    ) {
        var _this = this;
