    ...
    */
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.AuthService.getUserId() /* resolve(true) */
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(AuthService, router) {
        ...
        this.AuthService = AuthService;
        this.router = router;
        this.isConnected = false; // If user is connected
        this.first_name = ''; // User's first name
        // Check if user connected
        this.getIsConnected = function () {
            _this.AuthService.getUserId()
                .then(function (apiResponse) {
                _this.isConnected = true;
                _this.first_name = apiResponse.data.first_name;
            })
                .catch(function (apiResponse) { Object(q__WEBPACK_IMPORTED_MODULE_3__["resolve"])(true); });
        };
    ...
    HeaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        */
        ,
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_auth_service_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], HeaderComponent);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getUserId = function () {
        // GET '/auth'
        return this.HttpClient.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/auth").toPromise()
            .then(this.getData)
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/quick-start-game/ANGclient/src/main.ts */"./src/main.ts");
